    ...
    <footer id="footer">
      <div className="footer-main">
        ...
        <div className="container">
          <img src={LGFOOTER} alt="Logo" className="logo" />
          ...
          <div className="wrap-fx">
            ...
            <ul className="list">
              ...
              <li>
                {
                  location === "/" ?
                    <Link to="FAQs" className='title-header'>FAQs</Link> :
                    <a href="/faqs" className='title-header'>FAQs</a>
                }
              </li>
            </ul>
          </div>
